...
fn env_to_vault_key(env_key: &str) -> Option<&'static str> {
    match env_key {
        ...
        "TWITTER_API_KEY" => Some("social.twitter.api_key"),
        "TWITTER_API_SECRET" => Some("social.twitter.api_secret"),
        "TWITTER_ACCESS_TOKEN" => Some("social.twitter.access_token"),
        "TWITTER_ACCESS_TOKEN_SECRET" => Some("social.twitter.access_token_secret"),
        "LINKEDIN_ACCESS_TOKEN" => Some("social.linkedin.access_token"),
        "LINKEDIN_PERSON_ID" => Some("social.linkedin.person_id"),
        "BLUESKY_HANDLE" => Some("social.bluesky.handle"),
        "BLUESKY_APP_PASSWORD" => Some("social.bluesky.app_password"),
        "FACEBOOK_ACCESS_TOKEN" => Some("social.facebook.access_token"),
        "FACEBOOK_PAGE_ID" => Some("social.facebook.page_id"),
        "INSTAGRAM_ACCESS_TOKEN" => Some("social.instagram.access_token"),
        "INSTAGRAM_USER_ID" => Some("social.instagram.user_id"),
        "TIKTOK_ACCESS_TOKEN" => Some("social.tiktok.access_token"),
        "YOUTUBE_ACCESS_TOKEN" => Some("social.youtube.access_token"),
        "PINTEREST_ACCESS_TOKEN" => Some("social.pinterest.access_token"),
        "PINTEREST_BOARD_ID" => Some("social.pinterest.board_id"),
        "REDDIT_ACCESS_TOKEN" => Some("social.reddit.access_token"),
        "REDDIT_SUBREDDIT" => Some("social.reddit.subreddit"),
        "THREADS_ACCESS_TOKEN" => Some("social.threads.access_token"),
        "THREADS_USER_ID" => Some("social.threads.user_id"),
        "MASTODON_ACCESS_TOKEN" => Some("social.mastodon.access_token"),
        "MASTODON_INSTANCE" => Some("social.mastodon.instance"),
        "DISCORD_BOT_TOKEN" => Some("social.discord.bot_token"),
        "DISCORD_CHANNEL_ID" => Some("social.discord.channel_id"),
        "DISCORD_WEBHOOK_URL" => Some("social.discord.webhook_url"),
        "SLACK_BOT_TOKEN" => Some("social.slack.bot_token"),
        "SLACK_CHANNEL" => Some("social.slack.channel"),
        "MEDIUM_TOKEN" => Some("social.medium.token"),
        "DEVTO_API_KEY" => Some("social.devto.api_key"),
        "HASHNODE_API_KEY" => Some("social.hashnode.api_key"),
        "HASHNODE_PUBLICATION_ID" => Some("social.hashnode.publication_id"),
        "WORDPRESS_SITE_URL" => Some("social.wordpress.site_url"),
        "WORDPRESS_USERNAME" => Some("social.wordpress.username"),
        "WORDPRESS_APP_PASSWORD" => Some("social.wordpress.app_password"),
        _ => None,
    }
}
