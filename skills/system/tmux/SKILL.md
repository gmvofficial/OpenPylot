...
```bash
SOCKET_DIR="${OPENCLAW_TMUX_SOCKET_DIR:-${CLAWDBOT_TMUX_SOCKET_DIR:-${TMPDIR:-/tmp}/pylot-tmux-sockets}}"
mkdir -p "$SOCKET_DIR"
SOCKET="$SOCKET_DIR/pylot.sock"
SESSION=pylot-python
...
- Default socket path: `"$OPENCLAW_TMUX_SOCKET_DIR/pylot.sock"`.
